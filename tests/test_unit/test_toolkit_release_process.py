...
<!--renovate-debug:eyJjcmVhdGVkSW5WZXIiOiI0MC4xNi4wIiwidXBkYXRlZEluVmVyIjoiNDAuMTYuMCIsInRhcmdldEJyYW5jaCI6Im1haW4iLCJsYWJlbHMiOlsiZGVwZW5kZW5jaWVzIiwicmVub3ZhdGUiXX0=-->""",
    ...
    yield pytest.param(
        """fix: increase DM query limit for canvas components from default 100 to 1000 (#2334)
# Description

The default limit for NodeResultSetExpression and
EdgeResultSetExpression is quite low at 100 and I encountered a case
where I ended up losing some annotations when downloading and uploading
a Canvas. I believe we could increase the individual limits for each
type of subquery to accommodate for cases where users end up with large
canvases mostly consisting of annotations and so on. Setting it to 1000
for each type of Canvas entity should be safe and does not require any
pagination.
...
Co-authored-by: Magnus <magnus@cognitedata.com>
""",
        "0.5.16",
        """## Changelog
