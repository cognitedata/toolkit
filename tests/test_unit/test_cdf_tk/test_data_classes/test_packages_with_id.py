"""Unit tests for Package and ModuleToml data classes with ID field support."""
...
class TestPackageWithId:
    """Test Package data class with ID field support."""
...
class TestPackagesLoadWithId:
    """Test Packages loading with ID support."""
