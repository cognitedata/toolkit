...
from cognite_toolkit._cdf_tk.yaml_classes.extraction_pipeline import ExtractionPipelineYAML
...
def invalid_extraction_pipeline_test_cases() -> Iterable:
    ...
    yield pytest.param(
        ...
        {
            "Invalid value at dataSetExternalId: Input should be a valid string. Got 123 of type "
