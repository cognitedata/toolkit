...
from cognite_toolkit._cdf_tk.yaml_classes.search_config import SearchConfigYAML
...
def invalid_search_config_test_cases() -> Iterable:
    ...
    yield pytest.param(
        ...
        {
            "Invalid value at columnsLayout[1].property: Input should be a valid string. Got 123 of type int. "
