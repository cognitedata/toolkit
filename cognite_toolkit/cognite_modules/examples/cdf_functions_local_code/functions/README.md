Add function functions by creating a folder for each function and putting a `function_config.yaml` file into that. If you want to schedule the function add a `schedule.yaml` file too.
