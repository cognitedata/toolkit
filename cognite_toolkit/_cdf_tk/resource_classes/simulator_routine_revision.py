...
class SimulatorRoutineRevisionYAML(ToolkitResource):
    ...
    external_id: str = Field(
        description="External ID of the simulator routine revision.", min_length=1, max_length=255
    )
    routine_external_id: str = Field(
        description="External ID of the simulator routine.", min_length=1, max_length=255
    )
