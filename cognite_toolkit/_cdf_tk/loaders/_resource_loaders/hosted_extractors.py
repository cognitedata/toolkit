...
class HostedExtractorSourceLoader(ResourceLoader[str, SourceWrite, Source, SourceWriteList, SourceList]):
    ...
    def iterate(self, data_set_external_id: str | None = None, space: str | None = None) -> Iterable[Source]:
...
class HostedExtractorDestinationLoader(
    ...
    def iterate(self, data_set_external_id: str | None = None, space: str | None = None) -> Iterable[Destination]:
...
class HostedExtractorJobLoader(ResourceLoader[str, JobWrite, Job, JobWriteList, JobList]):
    ...
    def iterate(self, data_set_external_id: str | None = None, space: str | None = None) -> Iterable[Job]:
...
class HostedExtractorMappingLoader(ResourceLoader[str, MappingWrite, Mapping, MappingWriteList, MappingList]):
    ...
    def iterate(self, data_set_external_id: str | None = None, space: str | None = None) -> Iterable[Mapping]:
