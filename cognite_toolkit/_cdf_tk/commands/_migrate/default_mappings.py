...
def create_default_mappings() -> list[ResourceViewMappingRequest]:
    ...
    return [
        ...
        ResourceViewMappingRequest(
            ...
            resource_type="event",
            view_id=ViewId(space="cdf_cdm", external_id="CogniteActivity", version="v1"),
            property_mapping={
                "startTime": "startTime",
                "endTime": "endTime",
                "description": "description",
        ...
        ResourceViewMappingRequest(
            ...
            view_id=ViewId(space="cdf_cdm", external_id="CogniteTimeSeries", version="v1"),
            property_mapping=ts_property_mapping,
        ),
        ResourceViewMappingRequest(
            external_id=TIME_SERIES_EXTRACTOR_ID,
            resource_type="timeseries",
            view_id=ViewId(space="cdf_extraction_extensions", external_id="CogniteExtractorTimeSeries", version="v1"),
        ...
        ResourceViewMappingRequest(
            ...
            resource_type="file",
            view_id=ViewId(space="cdf_extraction_extensions", external_id="CogniteExtractorFile", version="v1"),
