...
def create_default_mappings() -> list[ResourceViewMappingApply]:
    ...
    return [
        ...
        ResourceViewMappingApply(
            ...
            property_mapping={
                "annotatedResource.id": "edge.endNode",
                "annotationType": "edge.type.externalId",
                "creatingUser": "sourceCreatedUser",
                "creatingApp": "source",
                "status": "status",
                ...
                "data.description": "description",
                "data.pageNumber": "endNodePageNumber",
                "data.textRegion.confidence": "confidence",
                "data.textRegion.xMin": "endNodeXMin",
                "data.textRegion.xMax": "endNodeXMax",
                "data.textRegion.yMin": "endNodeYMin",
                "data.textRegion.yMax": "endNodeYMax",
                "data.text": "endNodeText",
            },
        ),
    ]
