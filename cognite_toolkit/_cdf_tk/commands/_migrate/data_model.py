...
SPACE_SOURCE = dm.ContainerApply(
    ...
    properties={
        ...
        "dataSetExternalExternalId": dm.ContainerProperty(
    ...
    indexes={
        ...
        "dataSetExternalId": BTreeIndex(["dataSetExternalExternalId"], cursorable=True),
    },
    constraints={
...
SPACE_SOURCE_VIEW = dm.ViewApply(
    ...
    properties={
        ...
        "dataSetExternalId": dm.MappedPropertyApply(
            container=SPACE_SOURCE.as_id(),
            container_property_identifier="dataSetExternalExternalId",
