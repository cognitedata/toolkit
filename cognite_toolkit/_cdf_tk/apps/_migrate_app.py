    ...
    def infield_data(
        ...
        if not target_candidates:
            raise typer.BadParameter(
                ...
                f"{HINT_LEAD_TEXT}Have you placed the CDMLocationConfig YAMLs generated by "
                "[bold]cdf migrate infield-configs[/] into a Toolkit module and deployed them with [bold]cdf deploy[/]?"
            )
