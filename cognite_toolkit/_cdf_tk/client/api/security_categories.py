...
from cognite_toolkit._cdf_tk.client.identifiers.identifiers import InternalIdUnwrapped
...
class SecurityCategoriesAPI(CDFResourceAPI[SecurityCategoryResponse]):
