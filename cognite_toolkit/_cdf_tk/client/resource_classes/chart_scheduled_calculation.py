...
class ChartScheduledCalculationRequest(ChartScheduledCalculation, UpdatableRequestResource):
    ...
    def as_update(self, mode: Literal["patch", "replace"]) -> dict[str, Any]:
        # period, offset, window size, and the write target are immutable.
        # Sending either target field is rejected: recreate the schedule to bind a new target and session.
