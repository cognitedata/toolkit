...
from cognite_toolkit._cdf_tk.resource_classes import FunctionAppYAML, FunctionScheduleYAML, FunctionsYAML
...
@final
class FunctionAppCRUD(FunctionCRUD):
    """A CDF Function scaffolded with the cognite-function-apps structure.

    Identical to FunctionCRUD for all API operations. The 'FunctionApp' kind signals
    that the module also contains a handler.py and requirements.txt generated by
    `cdf dev create FunctionApp`.
    """

    kind = "FunctionApp"
    yaml_file_kind = "Function"  # YAML filename uses .Function.yaml so the Toolkit deploys it as a CDF Function
    yaml_cls = FunctionAppYAML
