...
import pandas as pd
from cognite.client.data_classes import Asset, AssetList, AssetWrite, AssetWriteList, capabilities, ThreeDModelWriteList, ThreeDModel, ThreeDModelList, ThreeDModelWrite
...
class ThreeDModelLoader(ResourceLoader[str, ThreeDModelWrite, ThreeDModel, ThreeDModelWriteList, ThreeDModelList]):
    ...
    list_cls = AssetList
    list_write_cls = ThreefDModelWriteList
    kind = "3DModel"
