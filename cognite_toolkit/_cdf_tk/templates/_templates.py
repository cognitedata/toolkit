...
def copy_common_code(
    ...
    try:
        ...
        raise ToolkitFileExistsError(
            f"'common' dir already exists in function code dir: {function_source_dir}. This is not supported when "
            "common_function_code is set in your config.<env>.yaml file."
        ) from e
