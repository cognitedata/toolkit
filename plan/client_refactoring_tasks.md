...
The goal of this refactoring is to create internal ResourceAPI classes for all resources that
Toolkit uses instead of relying on the external ResourceAPI from the `cognite-sdk` package.
